...
// RunTrajectorySimple()
//
void RunTrajectorySimple(FastResearchInterface *FRI, float joint_angles[7])
{
	unsigned int				i							=	0		;
	...
	{	
		printf("Set Joint Position Control Mode Manually.\n");
					delete	RML;
			delete	IP;
			delete	OP;
		return;
	...
	for ( i = 0; i < NUMBER_OF_JOINTS; i++)
	{
		...
		IP->TargetPosition->VecData			[i]	=	(double)joint_angles[i];
